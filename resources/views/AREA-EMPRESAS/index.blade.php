...
<div class="container">
    ...
    <div class="container my-5">
        <div class="row p-4 pb-0 pe-lg-0 pt-lg-5 align-items-center rounded-3 border shadow-lg">
            <div class="col-lg-7 p-3 p-lg-5 pt-lg-3">
                ...
                <br>
                <p class="lead"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        class="bi bi-check-lg" viewBox="0 0 16 16">
                        <path
                            d="M12.736 3.97a.733.733 0 0 1 1.047 0c.286.289.29.756.01 1.05L7.88 12.01a.733.733 0 0 1-1.065.02L3.217 8.384a.757.757 0 0 1 0-1.06.733.733 0 0 1 1.047 0l3.052 3.093 5.4-6.425z" />
                    </svg> Mais de 76.000 fornecedores já confiam em nós.</p>
                <p class="lead"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        class="bi bi-check-lg" viewBox="0 0 16 16">
                        <path
                            d="M12.736 3.97a.733.733 0 0 1 1.047 0c.286.289.29.756.01 1.05L7.88 12.01a.733.733 0 0 1-1.065.02L3.217 8.384a.757.757 0 0 1 0-1.06.733.733 0 0 1 1.047 0l3.052 3.093 5.4-6.425z" />
            ...
            <div class="col-md-10 mx-auto col-lg-5" style="margin-left: 35px;">
                <form class="form p-4 p-md-5 rounded-3">
                    <div class="form-floating mb-3">
                        ...
                        <div class="input-container text-center">
                            <input type="email" placeholder="empresa@email.com" required
    ...
    <div class="container col-xxl-8 px-4 py-5">
        <div class="row align-items-center g-5 py-5">
            ...
            <div class="col-12 col-lg-6 order-2 order-lg-last d-flex justify-content-center justify-content-lg-end">
                <img src="{{asset('assets/imagens/banner-500.jpg')}}" class="img-fluid" alt="Bootstrap Themes"
    ...
    <div class="px-4 py-5 my-5 text-center">
        <img class="d-block mx-auto mb-4" src="{{asset('assets/imagens/logo-square.svg')}}" alt="" width="72" height="57">
