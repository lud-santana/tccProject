                    ...
                    <ul class="navbar-nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="#">Calculadora de Festa</a></li>
                            </ul>
                        </li>
                        <li>
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img class="w-100 img-fluid d-md-none" src="{{asset('assets/imagens/banner-mobile.gif')}}" alt="banner principal">
            <img class="w-100 img-fluid d-none d-md-block d-xl-none" src="{{asset('assets/imagens/banner-tablet.gif')}}"
                alt="banner principal">
            <img class="w-100 img-fluid d-none d-xl-block" src="{{asset('assets/imagens/banner-desktop.gif')}}" alt="banner principal">
        </div>
    </div>

    <!-- FORNECEDORES -->
    <div class="px-4 py-5 my-5 text-center">
        <h1 class="display-5 fw-bold text-body-emphasis">Fornecedores</h1>
        <div class="col-lg-6 mx-auto">
            ...
            <div class="d-grid gap-2 d-sm-flex justify-content-center justify-content-sm-center mx-auto">
                <a href="area-empresas.html"><button type="button" class="btn-fornecedor px-4 gap-3">Seja um
                        fornecedor</button></a>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row align-items-md-stretch">
            <div class="col-md-6 mb-4 d-flex">
                <div class="d-flex flex-column justify-content-between h-100 p-5 bg-body-tertiary border rounded-3"
                    style="background-color: #fa7e14 !important; color: #F8F9FA;">
                    <div>
                    ...
                    <button class="btn btn-orange mt-4" type="button">Example button</button>
                </div>
            </div>
            <div class="col-md-6 mb-4 d-flex">
                <div class="d-flex flex-column justify-content-between h-100 p-5 bg-body-tertiary border rounded-3"
                    style="background-color: #d63384 !important; color: #F8F9FA;">
                    <div>
                        <h2>Add borders</h2>
                    ...
                    <button class="btn btn-pink mt-4" type="button">Example button</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container my-5">
        <div class="row p-4 pb-0 pe-lg-0 pt-lg-5 align-items-center rounded-3 border shadow-lg">
            <div class="col-lg-7 p-3 p-lg-5 pt-lg-3">
                <h1 class="display-4 fw-bold lh-1 text-body-emphasis">Conheça mais sobre nosso objetivo</h1>
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-center justify-content-lg-start mb-4 mb-lg-3">
                    <a href="sobre.html"><button type="button" class="btn btn-primary btn-lg px-4 gap-3">Saiba
                            mais</button></a>
                </div>
            </div>
            <div class="col-lg-4 offset-lg-1 p-0 text-center text-lg-start">
                <img class="rounded-lg-3" src="{{asset('assets/imagens/logo-oval.png')}}" alt="logo" width="200">
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <footer class="py-3 my-4">
            ...
            <div class="text-center">
                <a href="#">
                    <img src="{{asset('assets/imagens/logo-square.png')}}" alt="Logo" width="50" height="50">
                </a>
            </div>
        </footer>
    </div>
