<body>
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img class="w-100 img-fluid d-md-none" src="assets/imagens/banner-mobile.gif" alt="banner principal">
            <img class="w-100 img-fluid d-none d-md-block d-xl-none" src="assets/imagens/banner-tablet.gif"
                alt="banner principal">
            <img class="w-100 img-fluid d-none d-xl-block" src="assets/imagens/banner-desktop.gif" alt="banner principal">
        </div>
    </div>
    ...
    <div class="px-4 py-5 my-5 text-center">
        ...
        <div class="col-lg-6 mx-auto">
            ...
            <div class="d-grid gap-2 d-sm-flex justify-content-center justify-content-sm-center mx-auto">
                <a href="{{ route('cadastroEmpresas') }}"><button type="button" class="btn-fornecedor px-4 gap-3">Seja um
                        fornecedor</button></a>
            </div>
        </div>
    </div>
    ...
    <div class="container my-5">
        <div class="row p-4 pb-0 pe-lg-0 pt-lg-5 align-items-center rounded-3 border shadow-lg">
            ...
            <div class="col-lg-4 offset-lg-1 p-0 text-center text-lg-start">
                <img class="rounded-lg-3" src="assets/imagens/logo-oval.png" alt="logo" width="200">
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <footer class="py-3 my-4">
            <ul class="nav justify-content-center border-bottom pb-3 mb-3">
                ...
                <li>
                    <a class="nav-link px-2 text-body-secondary" href="{{ route('areaEmpresas') }}">
                        Área Empresas
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                            class="bi bi-briefcase-fill" viewBox="0 0 16 16">
                            <path
